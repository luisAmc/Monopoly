                        ...
                        //------------------------------------------------------------------------------------------------------------
                         ...
                         if (rr->getAvailable()){
                            ...
                            switch (sb->getId()){
                                ...
                                case 5:
                                pj2_position = 10;
                                pj1_image.setPosition(board_positions[pj2_position].x, board_positions[pj2_position].y);
                                window.draw(pj2_image);
                                break;
                                case 6:
                                pj2.setMoney(pj2.getMoney() - sb->getRent());
                    ...
                    while (save_window.isOpen()) {
                        ...
                        while (save_window.pollEvent(wEvent)) {
                            switch(wEvent.type) {
                                ...
                                case sf::Event::MouseButtonPressed:
                                if (close_button_rect.contains(sf::Mouse::getPosition(save_window))) {
                                    ofstream output("./resources/ranura2.txt");
                                    output << pj1.getName() << "#" << pj1.getMoney() << "#" << pj1_position;
                                    for (int i = 0; i < mini_pj1.size(); i++)
                                        output << "#" << mini_pj1[i];
                                    output << endl
                    ...
                    while (save_window.isOpen()) {
                        ...
                        while (save_window.pollEvent(wEvent)) {
                            switch(wEvent.type) {
                                ...
                                case sf::Event::MouseButtonPressed:
                                if (close_button_rect.contains(sf::Mouse::getPosition(save_window))) {
                                    ofstream output("./resources/ranura3.txt");
                                    output << pj1.getName() << "#" << pj1.getMoney() << "#" << pj1_position;
                                    for (int i = 0; i < mini_pj1.size(); i++)
                                        output << "#" << mini_pj1[i];
                                    output << endl
